...
const products = [
  ...
  },
  {
    ...
    pain: "need buildable tool ideas from real AI usage signals",
    whatItDoes:
      "turns one fresh AI success signal into core features, build steps, and a full Code X Prompt",
  ...
  },
  {
    ...
    whatItDoes: "shows the latest signal, what happened, what to build, and why it is useful",
    price: "free preview",
    status: "live",
    cta: "Try free match",
    href: "/goldmine",
